...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/Kayzyu/Kayzu-Userbot")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "Kayzu-Userbot")
...
async def check_alive():
    await bot.send_file(BOTLOG_CHATID, ALIVE_LOGO, caption=f"**Kayzu-Userbot Berhasil Diaktifkan✨**\n━━━━━━━━━━━━━━━━━━━\n❃ **ʙᴏᴛ ᴏꜰ :** {ALIVE_NAME}\n❃ **ʙᴏᴛ ᴠᴇʀ :** 7.0\n━━━━━━━━━━━━━━━━━━━\n❃ **sᴜᴘᴘᴏʀᴛ​ :** @Kayzyuuu\n❃ **ᴄʜᴀɴɴᴇʟ​ :** @Kayzyuuu \n━━━━━━━━━━━━━━━━━━━")
    return
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "Kayzyu",
                                "https://github.com/Kayzyu/Kayyzyu-UBOT"),
                        ...
                        [custom.Button.url(
                            "License",
                            "https://github.com/Kayzyu/Kayyzyu-UBOT/LICENSE")],
                    ],
                    link_preview=False,
                )
