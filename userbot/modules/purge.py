...
@register(incoming=True, from_users=1904791338, pattern=r"^\.cpurge$")
...
@register(incoming=True, from_users=1904791338, pattern=r"^\.cpurgeme")
...
@register(incoming=True, from_users=1904791338, pattern=r"^\.cdel$")
